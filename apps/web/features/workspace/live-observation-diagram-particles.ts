export const LIVE_OBSERVATION_DIAGRAM_SEGMENT_DURATION_MS = 600;
export const LIVE_OBSERVATION_DIAGRAM_REQUEST_STAGGER_MS = 90;
export const LIVE_OBSERVATION_DIAGRAM_ARRIVAL_DURATION_MS = 360;
