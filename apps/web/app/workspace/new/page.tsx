        ...
        <div className="designDashboardShell">
          <aside className="designDashboardSidebar" aria-label="새 프로젝트 메뉴">
            ...
            <nav className="designDashboardNav" aria-label="새 프로젝트 관련 화면">
              ...
              <Link
                aria-current="page"
                className="designDashboardNavLink isActive"
                href="/workspace/new"
              >
          ...
          <section
            className="designDashboardMain workspaceNewMain"
          ...
          >
            <header className="designDashboardTopbar workspaceNewTopbar">
              <div>
                ...
                <p>프로젝트 이름을 정하고 시작 방식을 고르면 바로 다음 작업 화면으로 이어집니다.</p>
              </div>
            ...
            <div className="workspaceNewLayout">
              <section
                className="designDashboardPanel workspaceNewPanel"
                aria-labelledby="workspace-new-form-title"
              >
