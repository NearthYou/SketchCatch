...
function ReverseBoardCandidateSelectionPanel({
  ...
  return (
    <aside className="reverseCandidateSelectionPanel" aria-label="보드 후보 선택">
      ...
      {state.hasScanResult ? (
        <div className="reverseCandidateSelectionList" role="radiogroup" aria-label="보드 후보 선택">
        ...
        <div className="reverseCandidateSelectionEmpty">
          ...
          <span>오른쪽에서 기존 AWS 가져오기를 누르면 이곳에 보드 후보가 크게 표시됩니다.</span>
        </div>
      )}
