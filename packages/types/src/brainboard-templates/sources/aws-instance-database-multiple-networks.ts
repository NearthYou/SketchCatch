...
export const awsInstanceDatabaseMultipleNetworksFailedEvidence = {
  ...
  error:
    "Brainboard template clone failed: Create architecture returned HTTP 400 and Clone into current architecture left the recovery board unchanged",
  attempts: [
    {
...
} as const satisfies BrainboardFailedCaptureEvidence;
