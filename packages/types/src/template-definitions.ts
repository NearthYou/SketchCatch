...
export const templateDefinitions = [
  ...
  createTemplate({
    ...
    resources: [
      resource("vpc", "VPC", "aws", "aws_vpc", 360, 80, { cidrBlock: "10.20.0.0/16", enableDnsSupport: true, enableDnsHostnames: true }, "design"),
      resource("public-subnet", "Public Subnet", "aws", "aws_subnet", 100, 240, { cidrBlock: "10.20.1.0/24", vpcId: "@ref:vpc.id", availabilityZone: "ap-northeast-2a" }, "design", "vpc"),
      resource("app-subnet", "App Subnet", "aws", "aws_subnet", 360, 240, { cidrBlock: "10.20.2.0/24", vpcId: "@ref:vpc.id", availabilityZone: "ap-northeast-2a" }, "design", "vpc"),
      resource("db-subnet", "DB Subnet", "aws", "aws_subnet", 620, 240, { cidrBlock: "10.20.3.0/24", vpcId: "@ref:vpc.id", availabilityZone: "ap-northeast-2a" }, "design", "vpc"),
  ...
  createTemplate({
    ...
    resources: [
      resource("vpc", "VPC", "aws", "aws_vpc", 300, 80, { cidrBlock: "10.30.0.0/16", enableDnsSupport: true, enableDnsHostnames: true }, "design"),
      resource("subnet", "Public Subnet", "aws", "aws_subnet", 100, 260, { cidrBlock: "10.30.1.0/24", vpcId: "@ref:vpc.id", availabilityZone: "ap-northeast-2a" }, "design", "vpc"),
  ...
  createTemplate({
    ...
    resources: [
      resource("vpc", "VPC", "aws", "aws_vpc", 300, 80, { cidrBlock: "10.40.0.0/16", enableDnsSupport: true, enableDnsHostnames: true }, "design"),
      resource("subnet", "EKS Subnet", "aws", "aws_subnet", 100, 260, { cidrBlock: "10.40.1.0/24", vpcId: "@ref:vpc.id", availabilityZone: "ap-northeast-2a" }, "design", "vpc"),
