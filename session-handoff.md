...
- The latest provider-traffic regression and all 124 scoped Live Observation tests pass; root lint, root typecheck, and all root build tasks pass.
...
- No DB migration, dependency change, Terraform action, provider scale-out load cycle, or new infrastructure resource was performed.
