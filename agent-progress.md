...
- Focused target, Delivery integration, and return-path regressions pass 29/29. Independent review fixes cover multi-connection selection, Runtime inference, non-fabricated evidence, non-ECS URL entry, confirmed-field locking, and component responsibility separation. Workspace lint, typecheck, production build, harness, and diff checks pass.
