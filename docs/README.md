...
| [AI 작업 공유 장표](./gg/004_AI작업공유장표_gg.html) | gg 공유용 | gg AI 브랜치에서 구현한 API, 타입, 화면 연결을 팀원에게 설명할 때 |
| [AI 작업 공유 발표 스크립트](./gg/005_AI작업공유발표스크립트_gg.md) | gg 공유용 | 위 HTML 장표를 보면서 팀원에게 말할 발표 멘트를 준비할 때 |
