...
| [0013-hybrid-ai-provider-체인.md](./0013-hybrid-ai-provider-체인.md) | Hybrid 모드에서 Amazon Q, Bedrock, OpenAI, rule fallback 순서로 설명 provider를 전환한다 | AI provider 과금 정책, fallback 순서, provider metadata를 바꿀 때 |
