...
## Active-log compaction archive - 2026-07-21 (continued)

### Simplify fallback cost headings
...
### Remove visible sample identifiers from Cost Usage
...
### Shorten the Live Observation public traffic cooldown
...
### Remove the Repository-specific audience demo bypass
