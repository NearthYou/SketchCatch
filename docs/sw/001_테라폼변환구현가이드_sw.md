...
이 문서는 SW Terraform 변환 기능을 사람이 그대로 따라 만들 수 있게 정리한 구현 가이드다. 초기 GitHub 이슈용 계획 문서는 정리되었으므로, 최신 계약은 `docs/data-models.md`, `docs/architecture.md`, `docs/deployment.md`와 현재 코드의 shared type/API schema를 우선한다.
